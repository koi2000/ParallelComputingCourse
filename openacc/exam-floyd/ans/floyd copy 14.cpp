...
#pragma acc loop vector
            ...
            //             printf("%d",id);
            //             float* dij = new float[b];
            //             #pragma acc data copy(data[0:size2])
            //             for (int k = p * b; k < (p + 1) * b; k++) {
            //                 #pragma acc parallel loop gang worker num_workers(8) vector_length(64) async(1 + k)
            //                 for (int i = p * b; i < (p + 1) * b; i++) {
            //                     #pragma acc loop vector
            //                     for (int j = 0; j < p * b; j++) {
            //                         float tp = data[i * SIZE + k] + data[k * SIZE + j];
            ...
            //             #pragma acc data copy(data[0:size2])
            //             for (int k = p * b; k < (p + 1) * b; k++) {
            //                 #pragma acc parallel loop gang worker num_workers(8) vector_length(64) async(2 + k)
            //                 for (int j = p * b; j < (p + 1) * b; j++) {
            //                     #pragma acc loop vector
            //                     for (int i = 0; i < p * b; i++) {
            //                         float tp = data[i * SIZE + k] + data[k * SIZE + j];
...
// #pragma acc parallel loop gang worker num_workers(4) vector_length(256)
