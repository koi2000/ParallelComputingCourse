...
// //             }
//             for (int k = p * b; k < (p + 1) * b; k++) {
// #pragma acc parallel loop gang worker num_workers(4) vector_length(256) async(1 + k)
//                 for (int i = p * b; i < (p + 1) * b; i++) {
//                     if (data[i * SIZE + k] == -INF) continue;
// #pragma acc loop vector
//                     for (int j = 0; j < p * b; j++) {
...
//                     }
//                 }
// #pragma acc parallel loop gang worker num_workers(4) vector_length(256) async(2 + k)
//                 for (int j = p * b; j < (p + 1) * b; j++) {
